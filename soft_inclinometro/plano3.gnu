...
set xlabel offset -65,-2
set ylabel offset 65,0.2
...
#Texto angulos
set label sprintf("Xº = %.2f urad ; Yº = %.2f urad",alfa/1e-6,beta/1e-6) at 3,3.5,0
#set label sprintf("Beta = %.2f urad",beta/1e-6) at 3.8,1.8,0

set view 64,135 #Done implicitly by mousing.
replot