...
set xlabel offset -2,6
set ylabel offset -65,0.5
...
#Texto angulos
set label sprintf("Xº = %.2f urad ; Yº = %.2f urad",alfa/1e-6,beta/1e-6) at -5,4,0
#set label sprintf("Beta = %.2f urad",beta/1e-6) at -5,4,0

set view 73,229 #Done implicitly by mousing.
replot